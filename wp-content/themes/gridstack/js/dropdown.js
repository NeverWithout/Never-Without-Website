    ...
    e.prototype = {
        ...
        init: function (a, c) {
            ...
            b.$options.length && (b.$options.each(function (a) {
                ...
                c.hasClass("label") && 0 == a ? (b.hasLabel = !0, b.label = c.text(), c.attr("data-filter", "")) : b.options.push({
                    domNode: c[0],
                    title: c.text(),
        ...
        render: function () {
            ...
            d.each(a.options, function () {
                a.$dropDown.append('<li' + (this.selected ? " class='active'" : '') + ' data-filter="'+this.filter+'">'+this.title+'</li>')
            });
