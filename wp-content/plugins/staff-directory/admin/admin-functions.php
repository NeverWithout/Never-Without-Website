...
function add_new_staff_member(){
		...
		if(isset($_GET['action']) && $_GET['action'] == 'addStaffMember' && !isset($_POST['name-to-add'])){
			...
			$output .= "<form method=\"post\" enctype=\"multipart/form-data\">
						<table class=\"widefat\">
							...
							<tr>
								<td>LinkedIn URL:</td>
								<td><textarea name=\"linkedin\" cols=38 rows=8></textarea></td>
							</tr>
							<tr>
								<td>Category:</td>
								<td>
		...
		if(isset($_POST['name-to-add'])){
          ...
          `linkedin`,
					...
					VALUES (
					'null',  '" . $_POST['name-to-add'] . "',  '" . $_POST['position'] . "',  '" . $_POST['email_address'] . "',  '" . $_POST['phone_number'] . "',  '" . $_FILES['staff-photo']['name'] . "',  '" . $_POST['bio'] . "',  '" . $_POST['linkedin'] . "',  '" . $_POST['category'] . "'
					);";
...
function edit_staff_member(){
		...
		if(isset($_POST['name'])){
			...
			$sql = "UPDATE  " . STAFF_DIRECTORY_TABLE . " SET  `name` =  '" . $_POST['name'] . "', position = '" . $_POST['position'] . "', email_address = '" . 			$_POST['email_address'] . "', phone_number = '" . $_POST['phone_number'] . "', bio = '" . $_POST['bio'] . "', linkedin = '" . $_POST['linkedin'] . "', category = '" . $_POST['category'] . "', photo ='" . $photo . "' 			WHERE  `staff_id` =  " . $id . ";";
			...
			$output .= "</td>
						...
						<tr>
							<td>LinkedIn Url:</td>
							<td><input name=\"linkedin\" value=\"" . $staff->linkedin . "\"></td>
						</tr>
						<tr>
							<td>Category:</td>
							<td>
