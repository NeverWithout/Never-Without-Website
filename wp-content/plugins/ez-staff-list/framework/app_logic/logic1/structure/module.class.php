...
* @version 		Started: 1-19-2006, Last updated: 8-31-2011
**/
	...
	**/
	...
	public function add_css_file($file_attrs)
	{
		if (is_array($file_attrs)) {
			...
			trigger_error('Error: page::add_css_file() - Passed value must be an array of attributes!');
		}
	}
