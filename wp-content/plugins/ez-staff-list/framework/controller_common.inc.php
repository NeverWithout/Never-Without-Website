...
*
* @package		phpOpenFW
* @subpackage	Controller Common
* @author 		Christian J. Clark
* @copyright	Copyright (c) Christian J. Clark
* @license		http://www.gnu.org/licenses/gpl-2.0.txt
* @version 		Started: 12/19/2011, Last updated: 12/27/2011
**/
//****************************************************************************
//****************************************************************************
...
function load_form_elements()
{
	...
	if (is_dir($form_elem_dir)) {
		...
		include_once($form_elem_dir . '/complex/sds.class.php');
		include_once($form_elem_dir . '/jsv.class.php');
		return true;
	}
	return false;
}
