...
* @version 		Started: 2-25-2008, Last updated: 8-31-2011
**/
...
class server_side_validation
{
	...
	**/
	...
	//**************************************************************************************
	public function display_fail_messages($new_xsl=null)
	{
		if (!is_null($new_xsl) && file_exists($new_xsl)) { $this->xsl = $new_xsl; }
		$fail_xml = array2xml('failed_checks', $this->fail_messages());
		xml_transform($fail_xml, $this->xsl);
	}
}
