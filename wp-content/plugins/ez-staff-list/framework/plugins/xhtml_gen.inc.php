...
* @version 		Started: 3/9/2012, Last updated: 3/9/2012
**/
...
if (!function_exists('form')) { function ez_form($c, $a=false) { return xhe('form', $c, $a); } }
if (!function_exists('label')) { function ez_label($c, $a=false) { return xhe('label', $c, $a); } }
if (!function_exists('option')) { function ez_option($c, $a=false) { return xhe('option', $c, $a); } }
if (!function_exists('button')) { function ez_button($c, $a=false) { return xhe('button', $c, $a); } }
