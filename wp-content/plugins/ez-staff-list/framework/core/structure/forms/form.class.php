...
* @version 		Started: 10-6-2004 Updated: 12-22-2011
**/
...
class form extends element
{
	...
	**/
	...
	/**
	* @var integer Enable or disable javascript validation (1 - enable, 0 - disable (default))
	**/
	private $validation;
	...
	**/
	...
	/**
	* @var object The forms Javascript validation object
	**/
	private $jsv;
	...
	**/
	...
	public function render($buffer=false)
	{
		...
		if ($this->validation) {
			$this->attributes['onsubmit'] = 'return ' . $this->attributes['name'] . '_validate(this)';
			$this->jsv->set_form_name($this->attributes['name']);
			print new gen_element('script', $this->xml_escape($this->jsv->render(1)));			
		}
	...
	**/
	...
	//*************************************************************************
	/**
	* Set form javascript validation (1) - On, (0) - Off (default)
	* @param integer 1 - ON, 0 - OFF (default)
	**/
	//*************************************************************************
	public function set_validation($flip_bit)
	{
		if ($flip_bit) {
	...
	* @param string Name of second field if doing comparison validation
	**/
	//*************************************************************************
	public function add_validation($field, $valid_type, $valid_txt, $field2='')
	{
		if (isset($this->jsv)) {
			$this->jsv->add_valid($field, $valid_type, $valid_txt, $field2);
		}
	}
